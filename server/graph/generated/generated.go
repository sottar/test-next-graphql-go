...
func (ec *executionContext) field_Mutation_createCar_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalOCreateCarInput2ᚖtestᚋgraphᚋmodelᚐCreateCarInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createCar(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOCar2ᚖtestᚋgraphᚋmodelᚐCar(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_cars(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Car)
	fc.Result = res
	return ec.marshalOCar2ᚕᚖtestᚋgraphᚋmodelᚐCar(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOCar2ᚕᚖtestᚋgraphᚋmodelᚐCar(ctx context.Context, sel ast.SelectionSet, v []*model.Car) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOCar2ᚖtestᚋgraphᚋmodelᚐCar(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOCar2ᚖtestᚋgraphᚋmodelᚐCar(ctx context.Context, sel ast.SelectionSet, v *model.Car) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOCreateCarInput2ᚖtestᚋgraphᚋmodelᚐCreateCarInput(ctx context.Context, v interface{}) (*model.CreateCarInput, error) {
	if v == nil {
		return nil, nil
	}
